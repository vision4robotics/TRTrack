...
parser.add_argument('--cfg', type=str, default='/home/user/V4R/LSH/FDNT_C/experiments/config.yaml',
...
def main():
    ...
    if cfg.BACKBONE.PRETRAINED:
        ...
        backbone_path = os.path.join('/home/user/V4R/LSH/FDNT_C/pretrained_models/', cfg.BACKBONE.PRETRAINED)
