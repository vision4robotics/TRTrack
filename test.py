...
def main():
    parser = argparse.ArgumentParser(description='AFRT tracking')
    parser.add_argument('--dataset', default='DTB70',type=str,
            help='datasets')
    parser.add_argument('--config', default='./../experiments/config.yaml', type=str,
            help='config file')
    parser.add_argument('--snapshot', default='./snapshot/AFRT.pth', type=str,
    ...
    cur_dir = os.path.dirname(os.path.realpath(__file__))#获得file绝对路径后返回目录
