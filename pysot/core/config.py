...
__C.DATASET.VID = CN()
__C.DATASET.VID.ROOT = '/data1/Train_dataset/vid/crop511'
...
__C.DATASET.LaSOT.ROOT = '/data1/Train_dataset/lasot/crop511'         # LaSOT dataset path
__C.DATASET.LaSOT.ANNO = '/data1/Train_dataset/lasot/train.json'
